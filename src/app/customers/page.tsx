    ...
    <div className="space-y-8 font-sans pb-20 relative">
      ...
      <div className="grid grid-cols-1 md:grid-cols-4 gap-6">
        {[
          ...
          { label: 'Khách hàng Active', value: customers.filter(c => c.status === 'Active').length, sub: '92% tỉ lệ hoạt động', icon: User, color: 'black' },
          { label: 'Tổng chi tiêu', value: formatCurrency(customers.reduce((acc, c) => acc + c.totalSpent, 0)), sub: 'Trung bình 1.2tr/khách', icon: ShoppingBag, color: 'black' },
                    ...
                    <div className="flex justify-end gap-2">
                      ...
                      <div className="relative">
                        ...
                        {showActionsId === customer.id && (
                          <div className="absolute right-0 top-full mt-2 w-48 bg-pure-black border border-white/10 rounded-2xl shadow-2xl z-50 p-2 overflow-hidden">
          ...
          <>
            ...
            >
              ...
              <div className="pt-8 mt-auto">
                <button className="w-full bg-ticketbox-green hover:brightness-110 text-black font-black py-4 rounded-2xl transition-all shadow-xl shadow-ticketbox-green/20 uppercase tracking-widest text-sm">
